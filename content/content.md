...
### How Omnifood works (How it works)
...
### Omnifood works with any diet (Diet)
...
### We have 2 pricing plans (Pricing)
...
### Additional links [links not available yet] (Footer)
...
(Note: the order is subjective)

- Logo + Navigation
- Hero
- Featured In (right after or in the hero)
- How It Works (how omnifood works and what's it all about)
- Meals (and list of diets)
- Testimonial + gallery
- Pricing + Features
- Call to Action (last before the footer)
- Footer
